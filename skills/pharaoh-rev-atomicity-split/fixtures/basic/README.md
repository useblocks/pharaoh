...
up-link, `satisfies: ["FEAT_csv_export"]`, to its parent feature.
...
Both atoms carry `split_from: "comp_req__csv_export_bundle"` so a caller can trace them back to
the need they replace.
