---
name: pharaoh-vplan-review
description: Audit a single test case against ISO 26262-8 §6 axes plus vplan-specific axes (coverage of parent req, completeness of steps, clarity of expected outcome). Emits structured findings JSON.
chains_from: [pharaoh-vplan-draft]
